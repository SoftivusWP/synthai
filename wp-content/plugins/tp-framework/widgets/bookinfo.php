...
class Bookinfo_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __('Book Info Widget', 'tp-framework'), // Widget Name
            array('description' => __('A widget that displays book information.', 'tp-framework')) // Widget Description
        );
    }
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:', 'tp-framework'); ?></label>
        ...
        <button type="button" class="button add-repeater-item"><?php esc_html_e('Add Item', 'tp-framework'); ?></button>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('avatar_image')); ?>"><?php esc_html_e('Avatar Image URL:', 'tp-framework'); ?></label>
            ...
            <button type="button" class="button tp-image-upload-button"><?php esc_html_e('Upload Image', 'tp-framework'); ?></button>
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('avatar_name')); ?>"><?php esc_html_e('Avatar Name:', 'tp-framework'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('avatar_designation')); ?>"><?php esc_html_e('Avatar Designation:', 'tp-framework'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('button_text')); ?>"><?php esc_html_e('Button Text:', 'tp-framework'); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('button_text')); ?>" name="<?php echo esc_attr($this->get_field_name('button_text')); ?>" type="text" value="<?php echo esc_attr($button_text); ?>">
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('button_url')); ?>"><?php esc_html_e('Button URL:', 'tp-framework'); ?></label>
            ...
            jQuery(document).ready(function($) {
                ...
                $(document).on('click', '.tp-image-upload-button', function(e) {
                    ...
                    var customUploader = wp.media({
                        title: '<?php esc_html_e('Choose Image', 'tp-framework'); ?>',
                        library: {
                            type: 'image'
                        },
                        button: {
                            text: '<?php esc_html_e('Use this image', 'tp-framework'); ?>'
                        },
                        multiple: false
                    }).on('select', function() {
