...
class Themephi_Elementor_Text_Hover_Image_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('AI ', 'tp-elements'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Powered Image Recognition', 'tp-elements'),
            ]
        );
    ...
    protected function render() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const hoverElements = document.querySelectorAll('.tp-text-hover-image-text[data-widget-id="<?php echo esc_js($this->get_id()); ?>"]');
