    ...
    <div class="services-part">
	    ...
	    <div class="services-text">
			...
			<ul class="service-meta">
				...
				<li><span class="meta_trainer"><i class="fa fa-user-o"></i><?php echo esc_html( $settings['services_trainer'] ); ?></span></li>
				<?php } ?>
				...
				<li><span class="meta_time"><i class="fa fa-clock-o"></i><?php echo esc_html( $settings['services_schedule'] ); ?></span></li>
				<?php } ?>
				<?php if( !empty( $settings['services_fee'] ) ){ ?>
				<li><span class="meta_fee"><i class="fa fa-credit-card"></i><?php echo esc_html( $settings['services_fee'] ); ?></span></li>
				<?php } ?>
			</ul>
			<?php } ?>
