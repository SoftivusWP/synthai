...
class Themephi_Elementor_Progress_Pie_Widget extends \Elementor\Widget_Base {
	...
	<div class="rs-pie-content">
		...
		<?php if(!empty($settings['rs_progress_title'])) : ?>
			<div <?php $attr_string = $this->print_render_attribute_string('rs_progress_title'); echo wp_kses_post( $attr_string ?? '' ); ?>><?php echo esc_html($settings['rs_progress_title']);?></div>
		<?php endif; ?>
	</div>
