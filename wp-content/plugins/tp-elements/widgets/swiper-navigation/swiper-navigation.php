...
class Themephi_Elementor_Swiper_Navigation_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::SELECT,
				'default' => 'portfolio_navigation',				
				'options' => [
					'hero_navigation' => esc_html__('Hero Navigation', 'tp-elements'),
					'blog_navigation' => esc_html__('Blog Navigation', 'tp-elements'),														
					'portfolio_navigation' => esc_html__('Portfolio Navigation', 'tp-elements'),					
					'testimonial_navigation' => esc_html__('Testimonial Navigation', 'tp-elements'),					
					'service_navigation' => esc_html__('Service Navigation', 'tp-elements'),					
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::SELECT,
				'default' => 'portfolio_pagination',				
				'options' => [
					'hero_pagination' => esc_html__('Hero Pagination', 'tp-elements'),
					'blog_pagination' => esc_html__('Blog Pagination', 'tp-elements'),									
					'portfolio_pagination' => esc_html__('Portfolio Pagination', 'tp-elements'),						
					'testimonial_pagination' => esc_html__('Testimonial Pagination', 'tp-elements'),						
					'service_pagination' => esc_html__('Service Pagination', 'tp-elements'),						
				],
				'condition' => [
		...
		$this->add_control(
		    'navigation_wrapp_background',
		    [
		        'label' => esc_html__( 'Background Color', 'tp-elements' ),
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .tp-swiper-slider-navigation' => 'background-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        'name' => 'navigation_wrapp_border',
		        'selector' => '{{WRAPPER}} .tp-swiper-slider-navigation',
		    ]
		);

		$this->add_control(
		    'navigation_wrapp_border_radius',
		    [
		        'label' => esc_html__( 'Border Radius', 'tp-elements' ),
		        'type' => Controls_Manager::DIMENSIONS,
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .tp-swiper-slider-navigation' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);

		$this->add_control(
		    'navigation_wrapp_border_color_normal',
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .tp-swiper-slider-navigation' => 'border-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .tp-swiper-slider-navigation' => 'display: flex; flex-direction: {{VALUE}}'
                ],
				'separator' => 'before',
            ]
        );
		...
		$this->add_responsive_control(
		    'margin_navigation_button',
		    [
		        'label' => esc_html__( 'Margin', 'tp-elements' ),
		        'type' => Controls_Manager::DIMENSIONS,
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .tp-swiper-slider-navigation > div:not(:last-child)' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
		    ]
		);
        ...
        $this->add_group_control(
            ...
            [
                'name'      => 'navigation_gradient_bg_color',
                'label'     => esc_html__( 'Background Color', 'tp-elements' ),
		...
		$this->add_group_control(
            Group_Control_Background::get_type(),
            [
                'name'      => 'navigation_gradient_hover_bg_color',
                'label'     => esc_html__( 'Background Color', 'tp-elements' ),
                'types'     => [ 'classic', 'gradient' ],
		...
		$this->add_responsive_control(
		    'pagination_wrapp_padding',
		    [
		        'label' => esc_html__( 'Padding', 'tp-elements' ),
		        'type' => Controls_Manager::DIMENSIONS,
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .tp-hero-pagination ' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
		    ]
		);

		$this->add_control(
		    'pagination_wrapp_background',
		    [
		        'label' => esc_html__( 'Background Color', 'tp-elements' ),
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .tp-hero-pagination' => 'background-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_group_control(
		    Group_Control_Border::get_type(),
		    [
		        'name' => 'pagination_wrapp_border',
		        'selector' => '{{WRAPPER}} .tp-hero-pagination',
		    ]
		);

		$this->add_control(
		    'pagination_wrapp_border_radius',
		    [
		        'label' => esc_html__( 'Border Radius', 'tp-elements' ),
		        'type' => Controls_Manager::DIMENSIONS,
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .tp-hero-pagination' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);

		$this->add_control(
		    'pagination_wrapp_border_color_norm',
		    [
		        'label' => esc_html__( 'Border Color', 'tp-elements' ),
		        'type' => Controls_Manager::COLOR,
		        'condition' => [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .tp-hero-pagination' => 'border-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    'pagination_bullet_hover_border_color_normal',
		    [
		        'label' => esc_html__( 'Border Color', 'tp-elements' ),
		        'type' => Controls_Manager::COLOR,
		        'condition' => [
	...
	if(  $settings['navigation_style'] == 'blog_navigation' ) {

		$nav_next_class = 'tp-blog-nav-next';
		$nav_prev_class = 'tp-blog-nav-prev';

	} elseif(  $settings['navigation_style'] == 'hero_navigation' ) {

		$nav_next_class = 'tp-hero-next';
		$nav_prev_class = 'tp-hero-prev';

	} elseif(  $settings['navigation_style'] == 'testimonial_navigation' ) {

		$nav_next_class = 'tp-testimonial-next';
		$nav_prev_class = 'tp-testimonial-prev';

	} elseif(  $settings['navigation_style'] == 'service_navigation' ) {

		$nav_next_class = 'tp-service-slide-next';
		$nav_prev_class = 'tp-service-slide-prev';

	} else {

		$nav_next_class = 'tp-portfolio-nav-next';
		$nav_prev_class = 'tp-portfolio-nav-prev';

	}

	if( $settings['slider_control_type'] =='pagination_only' ) {

		if( $settings[ 'pagination_style' ] == 'blog_pagination' ) {
			$pag_class = 'tp-blog-pagination ';
		} elseif( $settings[ 'pagination_style' ] == 'hero_pagination' ) {
			$pag_class = 'tp-hero-pagination ';
		} elseif( $settings[ 'pagination_style' ] == 'testimonial_pagination' ) {
			$pag_class = 'tp-testimonial-pagination ';
		} elseif( $settings[ 'pagination_style' ] == 'service_pagination' ) {
			$pag_class = 'tp-service-pagination';
		} else {
			$pag_class = 'tp-portfolio-pagination ';
		}
