...
class Themephi_Elementor_Counter_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .tps-counter-list' => 'justify-content: {{VALUE}}'
                ],                
				'separator' => 'before',
				'condition' => [
					'style' => 'style2',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
					'{{WRAPPER}} .counter-top-area .count-number span' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
         ...
         $this->add_group_control(
            ...
            [
				...
				'selector' => '{{WRAPPER}} .counter-top-area.yes .tps-counter-list  .count-text .rs-counter, {{WRAPPER}} .counter-top-area.yes .tps-counter-list  .count-text span.prefix, {{WRAPPER}} .counter-top-area.yes .tps-counter-list  .count-text span.suffix',
				'condition' => [
					'show_background' => 'yes',
				],
                'fields_options' => [
		...
		$this->start_controls_section(
			...
			$this->add_control(
			    ...
			    [
			    	...
			    	'size_units' => [ 'px', 'em', '%' ],
			    	'selectors' => [
			    	    '{{WRAPPER}} .counter-top-area .tps-counter-list .count-text .text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			    	],
			    ]
			);
	...
	protected function render() {
		...
		?>
		<style>
			.counter-top-area.yes .tps-counter-list .count-text .rs-counter, .counter-top-area.yes .tps-counter-list .count-text .suffix, .counter-top-area.yes .tps-counter-list .count-text .prefix {
