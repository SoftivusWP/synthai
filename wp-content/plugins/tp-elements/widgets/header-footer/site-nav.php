		...
		$this->start_controls_tabs( 'tabs_menu_item_style' );
			...
			$this->start_controls_tabs( 'tabs_menu_item_style_stikcy' );
				...
				$this->add_control(
					...
					[
						...
						'default'   => '',
						'selectors' => [
							'.tp-sticky {{WRAPPER}} .sticky-menu.menu-area .navbar ul > li > a' => 'color: {{VALUE}}',
						],
					]
				);
				...
				// sticky dropdown 
				$this->add_control(
					'sticky_color_dropdown_item',
					[
						'label'     => __( 'Dropdown Text Color', 'tp-elements' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
							'.tp-sticky {{WRAPPER}} .menu-area .navbar ul li ul.sub-menu li a' => 'color: {{VALUE}}',
						],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'selectors' => [
							'.tp-sticky {{WRAPPER}} .sticky-menu.menu-area .navbar ul > li:hover > a, .tp-sticky {{WRAPPER}} .sticky-menu.menu-area .navbar ul > li.current-menu-item > a' => 'color: {{VALUE}}',
						],
					]
				);	
				
				$this->add_control(
					'sticky_color_dropdown_item_hover',
					[
						'label'     => __( 'Dropdown Text Color', 'tp-elements' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
							'.tp-sticky {{WRAPPER}} .menu-area .navbar ul li ul.sub-menu li:hover> a 
							' => 'color: {{VALUE}}',
							'.tp-sticky {{WRAPPER}} .menu-area .navbar ul li ul.sub-menu:after 
				...
				$this->add_control(
					...
					[
						...
						'default'   => '',
						'selectors' => [
							'.tp-sticky {{WRAPPER}} .sticky-menu.menu-area .navbar ul > li.current-menu-item > a, .tp-sticky {{WRAPPER}} .sticky-menu.menu-area .navbar ul > li.current-menu-ancestor > a' => 'color: {{VALUE}}',
						],
					]
				);

				$this->add_control(
					'sticky_color_dropdown_item_active',
					[
						'label'     => __( 'Dropdown Text Color', 'tp-elements' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
							'.tp-sticky {{WRAPPER}} .menu-area .navbar ul li ul.sub-menu li.current-menu-item > a,
						
							.tp-sticky {{WRAPPER}} .menu-area .navbar ul li ul.sub-menu li.current-menu-ancestor >  a
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'#themephi-header .tp-sticky' => 'background: {{VALUE}} !important',
						'#themephi-header .tp-sticky .bg-remove' => 'background: {{VALUE}} !important',
					],
				]
			);	
