...
<div class="tp-portfolio-inner-content ">
    <div class="tp-portfolio-inner-content-text">
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="tp-portfolio-inner-content-text-wrapper mb-50 pr-lg-4">
                    <h2 class="tp-portfolio-inner-content-text-title"><?php echo the_title(); ?></h2>
                    
                    <?php if (!empty($excerpt)) : ?>
                    <div class="tp-excerpt-content">
            ...
            <div class="col-lg-3">
                <div class="tp-portfolio-inner-content-side mb-50">
                    ...
                    <div class="tp-portfolio-inner-side-single mb-20">
                        <h6 class="tp-portfolio-inner-side-title"><?php echo esc_html__('Category:', 'synthai'); ?></h6>
                        <?php echo wp_kses_post($cats_show); ?>
                    </div>
                    <?php endif; ?>
                    <?php if ($author_name) : ?>
                    <div class="tp-portfolio-inner-side-single mb-20">
                        <h6 class="tp-portfolio-inner-side-title"><?php echo esc_html__('Author:', 'synthai'); ?></h6>
                        <span><?php echo esc_html($author_name); ?></span>
                    </div>
                    <?php endif; ?>
                    <?php if( $post_date ) : ?>
                    <div class="tp-portfolio-inner-side-single mb-20">
                        <h6 class="tp-portfolio-inner-side-title"><?php echo esc_html__('Date:', 'synthai'); ?></h6>
            ...
            ?>
            <div class="col-lg-12">
                <div class="tp-portfolio-inner-content-gallery-wrapper tp-portfolio-inner-content-gallery-wrapper-<?php echo esc_attr( $count_img ); ?> mb-50">
