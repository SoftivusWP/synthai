		...
		<?php if(has_post_thumbnail()): ?>
			...
			<?php
				...
				<div class="quick-wish">
					<?php if ( function_exists( 'YITH_WCQV_Frontend' ) && $synthai_option['wc_quickview_icon']  ): ?>
						<div class="synthai-quick">					
							<a href="" class="yith-wcqv-button" data-product_id="<?php echo esc_attr( $product->get_id() );?>"><i class="far fa-eye"></i></a>
						</div>
					<?php endif; ?>
					
						<?php if ( class_exists( 'YITH_WCWL_Shortcode' ) && $synthai_option['wc_wishlist_icon'] ): ?>
							<div class="synthai-wishlist">
							<?php
								$args = array(
