...
if(!empty($synthai_option['facebook']) || !empty($synthai_option['twitter']) || !empty($synthai_option['rss']) || !empty($synthai_option['pinterest']) || !empty($synthai_option['google']) || !empty($synthai_option['instagram']) || !empty($synthai_option['vimeo']) || !empty($synthai_option['tumblr']) ||  !empty($synthai_option['youtube'])){
?>
