<?php
  if (is_home() && !is_front_page() || is_home() && is_front_page()){
		...
		$skew_style        = (!empty($synthai_option['skew_off'])) ? 'themephi-skew-head' : '';
...
$main_menu_center = (!empty($synthai_option['main_menu_center'])) || ($menu_center_page == 'yes')  ? 'main-menu-center' : '';

$main_menu_icon = (!empty($synthai_option['main_menu_icon'])) ? 'main-menu-icon-hide' : '';
