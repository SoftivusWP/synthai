<div class="sticky_form tps-search-popup">
    ...
    <div class="search-wrap">
    	<label class="screen-reader-text">
    		<?php echo esc_html__( 'Search for:', 'synthai' ); ?>
    	</label>
        <input type="search" placeholder="<?php esc_attr_e( 'Searching...', 'synthai' ); ?>" name="s" class="search-input" value="<?php echo esc_attr( get_search_query() ); ?>" />
