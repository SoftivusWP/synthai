...
$preloader_img = "";
if(!empty($synthai_option['show_preloader']))
  {
    $loading = $synthai_option['show_preloader'];
    
    if(!empty($synthai_option['preloader_img'])){
        $preloader_img = $synthai_option['preloader_img'];
    }
...
<?php 
    if(!empty($synthai_option['off_sticky'])):   
        $sticky = $synthai_option['off_sticky'];         
        if($sticky == 1):
