          ...
          <div class="row">
              ...
              <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>"> 
                ...
                <?php 
                    ...
                    ?>
                    <?php if(!empty($synthai_option['team_page_subtitle'])) : ?>
                        <span class="sub-title"><?php echo esc_html($synthai_option['team_page_subtitle']);?></span>
                    <?php endif; ?>
                    <h1 class="page-title">
                        <?php if(!empty($synthai_option['team_page_title'])){
                            echo esc_html($synthai_option['team_page_title']);
                            }else{
                               echo esc_html('Team Details', 'synthai');
                            }
                        ?>
                    </h1>
                    <?php } 
...
elseif (!empty($synthai_option['team_single_image']['url'])) {?>
<div class="breadcrumbs-single" style="background-image: url('<?php echo esc_url( $synthai_option['team_single_image']['url'] );?>')">
    <div class="container">
         <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>"> 
            <div class="row">        
